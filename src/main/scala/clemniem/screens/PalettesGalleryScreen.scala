...
import clemniem.{NavigateNext, Screen, ScreenId, StorageKeys, StoredPalette}
import clemniem.common.LocalStorageUtils
import tyrian.Html.*
import tyrian.*

/** Gallery of saved palettes. Empty state: "+ Create Palette". */
object PalettesGalleryScreen extends Screen {
  type Model = Option[List[StoredPalette]]
